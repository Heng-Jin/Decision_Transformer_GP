...
# train_data_path = '/scratch/uceehj1/dt/train_data_strategy_31_test'
...
class MyDataCollator:
    ...
    def __call__(self, examples):
        ...
        s, a, a_o, r, d, rtg, timesteps, mask = temp, a_temp, a_temp, temp, temp, temp, time_temp, time_temp
...
class TrainableDT(DecisionTransformerModel):
    ...
    def forward(self, **kwargs):
        ...
        # action_targets = kwargs["actions_output"]
