...
# trajectory_path = 'train_data_strategy_3'
# model_path = r"./output_3_plot_changed_retest_5e-4"
# penalty = 0.01
# function_path = r'./Onefunction_PI'
    ...
    for root, dirs, files in os.walk(trajectory_path):
        for file_name in files:
            if file_name.endswith(".json"):
                ...
                actions = torch.cat((torch.tensor(data['A'][0]).float().reshape(1, act_dim), torch.zeros((0, act_dim)).float()), dim=0)
